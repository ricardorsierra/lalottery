        ...
        ColReorder.prototype = {
            ...
            */
            ...
            "_fnMouseDown": function ( e, nTh ) {
                ...
                $(document)
                .on(
                    'mousemove.ColReorder', function (e) {
                        that._fnMouseMove.call(that, e);
                    } 
                )
                .on(
                    'mouseup.ColReorder', function (e) {
            ...
            "_fnMouseMove": function ( e ) {
                ...
                if (this.dom.drag === null ) {
                    ...
                    if (Math.pow(
                        ...
                        Math.pow(e.pageY - this.s.mouse.startY, 2), 0.5 
                    ) < 5 
                    ) {
                        return;
                    }
